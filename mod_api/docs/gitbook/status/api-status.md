...
- checked-in harness вместо обвязки, которая раньше писалась заново под каждый
  ...
  [`../tools/run_live_evidence.ps1`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/tools/run_live_evidence.ps1) выполняет
...
- [`../tools/judge_live_slice.ps1`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/tools/judge_live_slice.ps1) выносит
...
- процедура целиком, честная область действия и построчный список того, что
  ...
  в [`LIVE_EVIDENCE_RU.md`](../status/live-evidence.md). Чистый вердикт означает ровно
...
[`API_FREEZE_RU.md`](../status/api-freeze.md)): 58 публичных файлов, 46 interface IDs,
...
Замороженный контракт: [`../API_V3_RC1_FREEZE.md`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/API_V3_RC1_FREEZE.md).
Package signature/revocation contract:
[`PACKAGE_SIGNATURE_RC1.md`](../packages/signatures.md). Ручной live checklist:
[`../MANUAL_LIVE_VALIDATION_RU.md`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/MANUAL_LIVE_VALIDATION_RU.md).
...
[`WOTBMOD_PACKAGE_FORMAT_RU.md`](../packages/package-format.md), раздел
...
([`DAVA_NATIVE_PRIVATE_ABI_RU.md`](../reference/dava-native-abi.md)): шесть
...
[`../tests/v3_post_rc1_services_tests.cpp`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/tests/v3_post_rc1_services_tests.cpp)
