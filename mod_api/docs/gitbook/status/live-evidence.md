...
- [`../tools/run_live_evidence.ps1`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/tools/run_live_evidence.ps1) — гигиена,
  baselines, staging реплея, запуск, DPI-корректный захват, штатное закрытие,
  срез лога;
- [`../tools/judge_live_slice.ps1`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/tools/judge_live_slice.ps1) — пять ворот
  вердикта и exit code.

Ручной сценарий native-валидации по шагам остаётся в
[`../MANUAL_LIVE_VALIDATION_RU.md`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/MANUAL_LIVE_VALIDATION_RU.md); здесь —
...
3. Если `-OutputDirectory` всё же указывает внутрь рабочего дерева, выводится
   ...
   [`../.gitignore`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/gitignore) с шаблоном `live_evidence/`: кадры сняты с
...
[`../release/public_preview/uninstall.ps1`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/release/public_preview/uninstall.ps1)
...
[`../../proxy_dll/uninstall.cmd`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/proxy_dll/uninstall.cmd) удаляет
