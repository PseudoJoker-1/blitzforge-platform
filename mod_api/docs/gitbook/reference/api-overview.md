...
[`tests/API_TEST_MATRIX.md`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/tests/API_TEST_MATRIX.md), итоговый отчёт и
остаточные интеграционные риски — в
[`tests/API_TEST_REPORT.md`](https://github.com/PseudoJoker-1/wotb-mod-api/blob/main/mod_api/tests/API_TEST_REPORT.md).
